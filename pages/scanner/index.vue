    ...
    <v-row class="px-10">
      ...
      >
        ...
        <div class="my-10 black--text">
          ...
          <v-btn depressed color="secondary" dark @click="init"> Scan1 </v-btn>
...
const URL =  "https://teachablemachine.withgoogle.com/models/MJx6Ehv7H/";
...
export default {
  ...
  created() {
    ...
    //   "src",
    //   "//cdn.jsdelivr.net/npm/@teachablemachine/pose@0.8/dist/teachablemachine-pose.min.js"
    // );
  ...
  methods: {
    ...
    async init() {
      ...
      this.webcam = new tmPose.Webcam(400, 400,facingMode='front'); // width, height, flip
